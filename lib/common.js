...
function IsSegmentValid(Segment, FieldDelimeter) {
...
function GetEOLCharacter(document) {
...
function CreateNewDocument(documentText, documentLanguage) {
...
//----------------------------------------------------
// Queries the user preferences for the socket encoding preference.
// @returns {string} - returns the end of line characters for the document
function GetSocketEncodingPreference() {
	// select the socket encoding defined in the preferences
	var config = vscode.workspace.getConfiguration('hl7tools');

	switch (config['SocketEncoding']) {
		case "UTF-8":
			return "utf8";
		case "ISO-8859-1":
			return "latin1";
...
exports.IsSegmentValid = IsSegmentValid;
...
exports.GetEOLCharacter = GetEOLCharacter;
exports.CreateNewDocument = CreateNewDocument;
exports.GetSocketEncodingPreference = GetSocketEncodingPreference;