...
//									If not supplied, the function will default to using thew active document in the editor.
//
...
// TO DO: add optional true/fase parameter to truncate the string if longer than pad length (default to false)
...
//
// @returns {bolean} - returns true if the location string's syntax is valid. It does not confiem if the item is present in the message or not.
...
// ***	
// TO DO: Bug fix required. Using the segment name as the key limits the match to only one fields per segment - create a list of objects insted. The object should contain segment and field properties.	
// ***
